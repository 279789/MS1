...
\noindent
$\bm{\overline{U} = \frac{1}{T} \int_{0}^{T} u(t) \, dt} $\\

\noindent
mit \\

\noindent
$\bm{u(t) = \sin(\omega t) +K}$
...
$\overline{U} = \frac{1}{2.01ms} \int_{0}^{2.01\text{ms}} \sin \left(2 \pi \cdot  497.5\text{Hz} \cdot  t \right) -972.3\text{mV}  \, dt = -972,3mV $
